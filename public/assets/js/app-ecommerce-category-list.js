         ...
         render: function (e, t, a, o) {
            return `
              <div class="d-flex align-items-sm-center justify-content-sm-center">
                <button class="btn btn-icon" data-bs-toggle="modal" data-bs-target="#cobrarcuenta">cobrar</button>
                ...
                <div class="dropdown-menu dropdown-menu-end m-0">
                  <a href="javascript:void(0);" class="dropdown-item">Cobrar cuenta</a>
      ...
      responsive: {
         details: {
            ...
            renderer: function (e, t, a) {
               var o, s, r, a = a.map(function (e) {
                  return "" !== e.title ? `<tr data-dt-row="${e.rowIndex}" data-dt-column="${e.columnIndex}">
                      <td>${e.title}:</td>
                      <td>${e.data}</td>
                    </tr>` : ""
               }).join("");
               return !!a && ((o = document.createElement("div")).classList.add("table-responsive"), s = document.createElement("table"), o.appendChild(s), s.classList.add("table"), (r = document.createElement("tbody")).innerHTML = a, s.appendChild(r), o)
            }
         }
      }
   }), setTimeout(() => {
