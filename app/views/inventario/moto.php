  ...
  window.PERMISOS_USUARIO = <?= json_encode($_SESSION['permisos']) ?>;
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="app-ecommerce-category">
                    ...
                    <table class="datatables-category-list table">
                      <thead>
                        <tr>
                          ...
                          <th class="text-nowrap text-sm-start">Marcas de Motos</th>
                          <th class="text-lg-center">Total de Modelos</th>
                          <th class="text-lg-center">Modelos Activos</th>
                ...
                <!-- MODAL REGISTRAR -->
                <div class="modal fade" id="modalRegistrarMoto" tabindex="-1" aria-labelledby="modalRegistrarMotoLabel" aria-hidden="true">
                  <div class="modal-dialog modal-md modal-dialog-centered">
                    <div class="modal-content">
                      <form id="formRegistrarMarca" onsubmit="return true">
                        <div class="modal-header">
                          <h5 class="modal-title" id="modalRegistrarMotoLabel">Registrar Marca</h5>
                  ...
                  <div class="modal-dialog modal-md">
                    <div class="modal-content">
                      <form id="formEditarMarca">
                        ...
                        <div class="modal-body row g-3">
                          <input type="hidden" id="edit-id_moto" name="id_moto" />
                          <div class="col-12">
