                ...
                <div class="col-xxl-8 mb-6 order-0">
                  <div class="card">
                    <div class="d-flex align-items-start row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary mb-3">Bienvenido <?php echo ucfirst($_SESSION['id_usuario']); ?>  🎉</h5>
                          <p class="mb-6">descripciondelRol<br />.....</p>
                          <a href="pos/" class="btn btn-sm btn-outline-primary">Vende Ahora</a>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-6">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <h4 class="card-title mb-3">S/2,628</h4>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-6">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <p class="mb-1">Productos diarios</p>
                      ...
                      <div class="col-lg-8">
                        <div class="card-header d-flex align-items-center justify-content-between">
                          <div class="card-title mb-0">
                            <h5 class="m-0 me-2">Tendencias de Ventas</h5>
                          </div>
                          <div class="dropdown">
                    ...
                    <div class="col-6 mb-6 payments">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <h4 class="card-title mb-3">S/2,456</h4>
                    ...
                    <div class="col-6 mb-6 transactions">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <p class="mb-1">Yape</p>
                          <h4 class="card-title mb-3">S/14,857</h4>
                          ...
                          <div class="d-flex justify-content-between align-items-center flex-sm-row flex-column gap-10 flex-wrap">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                              <div class="card-title mb-6">
                                <h5 class="text-nowrap mb-1">Mejor vendedor</h5>
                                <span class="badge bg-label-warning">Año 2023</span>
                              </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-6">
                  <div class="card h-100">
                    <div class="card-header d-flex justify-content-between">
                      <div class="card-title mb-0">
                        <h5 class="mb-1 me-2">Categorias</h5>
