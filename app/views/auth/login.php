      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
          <div class="w-100 d-flex justify-content-center">
            <img src="<?= base_url('assets/img/illustrations/cmp.png') ?>" class="img-fluid" alt="Login image" width="700" />
          </div>
        </div>
        <!-- /Left Text -->
        <!-- Login -->
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6" style="background:white;height: 100%;position: absolute;right: 0;">
          <div class="w-px-400 mx-auto mt-sm-12 mt-8">
            ...
            <form id="formAuthentication" class="mb-6" action="<?= BASE_URL('auth/acceder') ?>" method="POST"><!-- login/auth -->
              ...
              <div class="my-7">
                <div class="g-recaptcha mb-4" data-sitekey="6Ld2w1ArAAAAAIGlkAtY6oN6MFPsRVtsYc9SJRtJ"></div>
              </div>

              <div class="my-7">
                <div class="d-flex justify-content-rigth">                  
                    <a href="<?= BASE_URL('auth/forgot') ?>"><p class="mb-0">¿Olvidaste tu contraseña?</p></a>
                </div>
              </div>
