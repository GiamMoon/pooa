  ...
  window.PERMISOS_USUARIO = <?= json_encode($_SESSION['permisos']) ?>;
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="app-ecommerce-category">
                    ...
                    <table class="datatables-category-list table">
                      <thead>
                        <tr>
                          ...
                          <th class="text-nowrap text-sm-start">Nombre Comercial</th>
                          <th class="text-nowrap text-sm-start">Dirección &nbsp;</th>
                          <th class="text-lg-center">Usuarios Asignados</th>
                ...
                <!-- MODAL REGISTRAR -->                
                <div class="modal fade" id="modalRegistrarSucursal" tabindex="-1" aria-labelledby="modalRegistrarSucursalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg modal-dialog-centered">
                    <form id="formRegistrarSucursal">
                      <div class="modal-content">
                        ...
                        <div class="modal-body row g-3">
                          ...
                          <div class="col-md-12">
                            ...
                            <input type="text" maxlength="255" id="nombre_comercial" name="nombre_comercial" class="form-control text-uppercase" placeholder="Ingrese Nombre Comercial"/>
                          </div>                          
                          <div class="col-12">
                            <label class="form-label">Dirección</label>
                            <input type="text" maxlength="250" class="form-control text-uppercase" id="direccion" name="direccion" placeholder="Ingrese Dirección"/>
                          </div>
                          <div class="col-md-4">
